...
(function(h) {
	...
	function la(a, b, c) {
		...
		c !== k && null !== c && (hb(c), J(l.defaults.column, c, !0), c.mDataProp !== k && !c.mData && (c.mData = c
		...
		!b.bSortable || !a && !c ? (b.sSortingClass =
			d.sSortableNone, b.sSortingClassJUI = "") : a && !c ? (b.sSortingClass = d.sSortableAsc, b
			.sSortingClassJUI = d.sSortJUIAscAllowed) : !a && c ? (b.sSortingClass = d.sSortableDesc, b
			.sSortingClassJUI = d.sSortJUIDescAllowed) : (b.sSortingClass = d.sSortable, b.sSortingClassJUI = d
			.sSortJUI)
	}
		...
		if ("string" === typeof a && (-1 !== a.indexOf(".") || -1 !== a.indexOf("[") || -1 !== a.indexOf("("))) {
			var b = function(a, d, e) {
				...
				for (var g, j, i = 0, h = e.length - 1; i < h; i++) {
					if ("__proto__" === e[i] || "constructor" === e[i]) throw Error(
	...
	function Ka(a, b, c, d) {
		var e = [],
			...
			G = function(a) {
				if (c === k || c === i) j = m[i], h = a.innerHTML.trim(), j && j._bAttrSrc ? (N(j.mData._)(d, h), s(
					j.mData.sort, a), s(j.mData.type, a), s(j.mData.filter, a)) : q ? (j._setter ||
	...
	function Ja(a, b, c, d) {
		...
		if (null === e.nTr) {
			...
			for (m = a.aoColumns.length; n < m; n++) {
				...
				g.push(e);
				if (q || (i.mRender || i.mData !== n) && (!h.isPlainObject(i.mData) || i.mData._ !== n +
						".display")) e.innerHTML = B(a, b, n, "display");
	...
	function Na(a, b) {
		...
		if (c) {
			...
			e && (c.id =
				e);
			d.DT_RowClass && (e = d.DT_RowClass.split(" "), b.__rowc = b.__rowc ? ra(b.__rowc.concat(e)) : e, h(c)
	...
	function mb(a) {
		...
		i && (e = h("<tr/>").appendTo(g));
		b = 0;
		for (c = m.length; b < c; b++) f = m[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures
			.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable &&
				(d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a, f.nTh, b))), f.sTitle !=
			d[0].innerHTML && d.html(f.sTitle), Pa(a, "header")(a, d, f, n);
		i && fa(a.aoHeader, g);
			...
			if ("<" == j) {
				...
				if ("'" == n || '"' == n) {
					...
					"H" == m ? m = b.sJUIHeader : "F" == m && (m = b.sJUIFooter); - 1 != m.indexOf(".") ? (n = m
							.split("."), i.id = n[0].substr(1, n[0].length -
								1), i.className = n[1]) : "#" == m.charAt(0) ? i.id = m.substr(1, m.length - 1) : i
						.className = m;
					k += q
				}
				e.append(i);
	...
	function ta(a, b, c) {
		...
		n = {
			...
			error: function(b, c) {
				var d = t(a, null, "xhr", [a, null, a.jqXHR]); - 1 === h.inArray(!0, d) && ("parsererror" ==
		...
		a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) {
			...
			url: g || a.sAjaxSource
		})) : "function" === typeof g ? a.jqXHR = g.call(j, b, i, a) : (a.jqXHR = h.ajax(h.extend(n, g)), g
			.data = f)
	}
	...
	function wb(a) {
		...
		for (g = 0; g < c; g++) n = b[g], m = f[g], i = "function" == typeof n.mData ? "function" : n.mData, G
			.columns.push({
				data: i,
				name: n.sName,
			...
			}), s("mDataProp_" + g, i), d.bFilter && (s("sSearch_" + g, m.sSearch), s("bRegex_" + g, m.bRegex), s(
				"bSearchable_" + g, n.bSearchable)), d.bSort && s("bSortable_" + g, n.bSortable);
	...
	function rb(a) {
		var b = a.oClasses,
			...
			n = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on(
	...
	function ha(a, b, c) {
		...
		if ("ssp" != y(a)) {
			...
			f(b);
			for (b = 0; b < e.length; b++) zb(a, e[b].sSearch, b, e[b].bEscapeRegex !== k ? !e[b].bEscapeRegex : e[
				b].bRegex, e[b].bSmart, e[b].bCaseInsensitive);
			Ab(a)
		} else f(b);
		a.bFiltered = !0;
		t(a, null, "search", [a])
	...
	function Ab(a) {
		for (var b = l.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f <
			g; f++) {
			for (var j = [], i = 0, n = c.length; i < n; i++) e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e,
				d._aData, i) && j.push(e);
			c.length = 0;
			h.merge(c, j)
		}
	...
	function zb(a, b, c, d, e, f) {
		if ("" !== b) {
			for (var g = [], j = a.aiDisplay, d = Ra(b, d, e, f), e = 0; e < j.length; e++) b = a.aoData[j[e]]
	...
	function Bb(a) {
		...
		for (f = a.aoData.length; d < f; d++)
			if (h =
				...
				j = [];
				e = 0;
				for (g = b.length; e < g; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), m[c.sType] && (
					i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i =
					i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Zb ?
					wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), j.push(i);
				h._aFilterData = j;
	...
	function ub(a) {
		...
		c || (a.aoDrawCallback.push({
			fn: Eb,
			sName: "information"
		}), d.attr("role", "status").attr("aria-live", "polite"), h(a.nTable).attr("aria-describedby", b +
			"_info"));
		return d[0]
	}
	...
	function qb(a) {
		for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = Array.isArray(d[0]), f = e ? d[0] : d, d =
				e ? d[1] : d, e = h("<select/>", {
					name: c + "_length",
					"aria-controls": c,
	...
	function Va(a, b, c) {
		...
		0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f &&
			...
			"next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : K(a, 0,
	...
	function ma(a) {
		...
		if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
			...
			if ("" === c) {
				t.width = "100%";
				if (V && (p.find("tbody").height() > j.offsetHeight || "scroll" == m.css("overflow-y"))) t.width =
					w(p.outerWidth() -
						b);
				f = p.outerWidth()
	...
	function I(a, b, c) {
		for (var d = 0, e = 0, f = b.length, g, j; e < f;) {
			...
			for (j = c ? c[e].firstChild :
				null; g;) 1 === g.nodeType && (c ? a(g, j, d) : a(g, d), d++), g = g.nextSibling, j = c ? j
				.nextSibling : null;
			e++
		}
	}
	...
	function Ha(a) {
		...
		if (d || !s && !f && !e && j == W(a) && j == n.length)
			...
			for (l = 0; l < i.length; l++) o = c[i[l]], n[l].style.width = null !== o.sWidthOrig && "" !== o
				.sWidthOrig ? w(o.sWidthOrig) : "", o.sWidthOrig && f && h(n[l]).append(h("<div/>").css({
					width: o.sWidthOrig,
					margin: 0,
					padding: 0,
					border: 0,
			...
			if (a.aoData.length)
				for (l = 0; l < i.length; l++) s = i[l], o = c[s], h(Hb(a, s)).clone(!1).append(o.sContentPadding)
					.appendTo(r);
			...
			f && g ? j.width(g) : f ? (j.css("width", "auto"), j.removeAttr("width"), j.width() < k.clientWidth &&
				m && j.width(k.clientWidth)) : e ? j.width(k.clientWidth) : m && j.width(m);
			for (l = e = 0; l < i.length; l++) k = h(n[l]), g = k.outerWidth() -
				k.width(), k = p.bBounding ? Math.ceil(n[l].getBoundingClientRect().width) : k.outerWidth(), e += k,
				c[i[l]].sWidth = w(k - g);
			b.style.width = w(e);
			o.remove()
		}
	...
	function Ib(a, b) {
		for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++) c = B(a, f, b, "display") + "", c = c
			.replace(ac, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f);
		return e
	}
	...
	function Y(a) {
		...
		for (a = 0; a < n.length; a++) {
			...
			f = e[i].aDataSort;
			b = 0;
			for (c = f.length; b < c; b++) g = f[b], j = e[g].sType || "string", n[a]._idx === k && (n[a]._idx = h
				.inArray(n[a][1], e[g].asSorting)), d.push({
				src: i,
				col: g,
				dir: n[a][1],
				index: n[a]._idx,
		...
		if ("ssp" !=
			...
			g === h.length ? i.sort(function(a, b) {
				...
				var c, g, j, i, k = h.length,
					...
					o = f[b]._aSortData;
				for (j = 0; j < k; j++)
					if (i = h[j], c = l[i.col], g = o[i.col], i = e[i.type + "-" + i.dir] || e["string-" + i
							.dir], c = i(c, g), 0 !== c) return c;
				c = d[a];
				g = d[b];
				return c <
					g ? -1 : c > g ? 1 : 0
	...
	function Wa(a, b, c, d) {
		...
		c && a.oFeatures.bSortMulti ? (c = h.inArray(b, C(e, "0")), -1 !== c ? (b = g(e[c], !0), null === b && 1 ===
	...
	function ya(a) {
		...
		if (e.bSort && e.bSortClasses) {
			e = 0;
			for (f = b.length; e < f; e++) g = b[e].src, h(C(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e +
				1 : 3));
			e = 0;
			for (f = d.length; e < f; e++) g = d[e].src, h(C(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 :
				3))
		}
		a.aLastSort = d
	}
					...
					if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 *
						...
						if (b.columns) {
							...
							for (e = b.columns.length; d < e; d++) g = b.columns[d], g.visible !== k && (f[d]
								.bVisible = g.visible), g.search !== k && h.extend(a.aoPreSearchCols[d], Db(g
								.search))
						}
	...
	function K(a, b, c, d) {
		...
		else if (b = l.ext, b = b.sErrMode || b.errMode, a && t(a, null, "error", [a, d, c]), "alert" == b) alert(
			c);
		else {
	...
	function Ya(a, b, c) {
		...
		for (e in b) b.hasOwnProperty(e) && (d = b[e], h.isPlainObject(d) ? (h.isPlainObject(a[e]) || (a[e] = {}), h
				.extend(!0, a[e], d)) : a[e] = c && "data" !== e && "aaData" !== e && Array.isArray(d) ? d
			.slice() : d);
		return a
	}
	...
	function ja(a, b) {
		var c = [],
			c = Mb.numbers_length,
			d = Math.floor(c / 2);
		b <= c ? c = Z(0, b) : a <= d ? (c = Z(0, c - 2), c.push("ellipsis"), c.push(b - 1)) : (a >= b - 1 - d ? c =
			Z(b - (c - 2), b) : (c = Z(a - d + 2, a + d - 1), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0,
	...
	var l = function(a) {
			...
			this.fnAddData = function(a, b) {
				var c = this.api(!0),
					d = Array.isArray(a) && (Array.isArray(a[0]) || h.isPlainObject(a[0])) ? c.rows.add(a) : c
					.row.add(a);
				(b === k || b) && c.draw();
			...
			this.each(function() {
				...
				if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" +
					...
					for (i = s.length; j < i; j++) {
						var o = s[j];
						if (o.nTable ==
							this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot
							.parentNode == this) {
					...
					p.iInitDisplayStart === k && (p.iInitDisplayStart = g.iDisplayStart, p._iDisplayStart =
						g.iDisplayStart);
					null !== g.iDeferLoading && (p.bDeferLoading = !0, e = Array.isArray(g.iDeferLoading), p
					...
					var e = p.asStripeClasses,
						v = q.children("tbody").find("tr").eq(0); - 1 !== h.inArray(!0, h.map(e, function(
						a) {
						return v.hasClass(a)
					...
					g.bStateSave ? (V.bStateSave = !0, z(p, "aoDrawCallback", za, "state_save"), Lb(p, g,
						e)) : e()
				}
			});
			b = null;
			...
			for (j = m.length; g < j; g++) {
				...
				if (b ===
					...
					for (h = o.length; i < h; i++) {
						f = o[i];
						f = b === "cell" ? c.call(t, m[g], f.row, f.column, g, i) : c.call(t, m[g], f,
							g, i, l);
						f !== k && e.push(f)
					}
				}
	...
	r.registerPlural = u = function(a, b, c) {
		...
		r.register(b, function() {
			...
			return a === this ? this : a instanceof r ? a.length ? Array.isArray(a[0]) ? new r(a
				.context, a[0]) : a[0] : k : a
		})
	};
	var Vb = function(a, b) {
	...
	o("page.len()", function(a) {
		return a === k ? this.context.length !== 0 ? this.context[0]._iDisplayLength : k : this.iterator(
			"table",
			function(b) {
				Ta(b,
					a)
	...
	var bb = function(a, b, c, d, e) {
			...
			for (h = b.length; i < h; i++) {
				...
				m = 0;
				for (l = j.length; m < l; m++)(g = c(typeof j[m] === "string" ? j[m].trim() : j[m])) && g.length &&
					(f = f.concat(g))
			}
			a = v.selector[a];
			if (a.length) {
	...
	o("rows.add()", function(a) {
		var b = this.iterator("table", function(b) {
				...
				for (g =
					a.length; f < g; f++) {
					c = a[f];
					c.nodeName && c.nodeName.toUpperCase() === "TR" ? h.push(oa(b, c)[0]) : h.push(O(b,
						c))
				}
				return h
			}, 1),
	...
	o("cells()", function(a, b, c) {
		...
		if (b === null || b === k) return this.iterator("table", function(b) {
			...
			return bb("cell", d, function(a) {
				...
				if (a === null || a === k || c) {
					...
					for (r = g.length; u < r; u++) {
						...
						for (t = 0; t < n; t++) {
							...
							if (c) {
								v = f[l];
								a(w, B(b, l, t), v.anCells ? v.anCells[t] : null) && o
									.push(w)
							} else o.push(w)
						}
					}
				...
				if (h.isPlainObject(a)) return a.column !== k && a.row !== k && h
					.inArray(a.row, g) !== -1 ? [a] : [];
	...
	o("search()", function(a, b, c, d) {
		var e = this.context;
		return a === k ? e.length !== 0 ? e[0].oPreviousSearch.sSearch : k : this.iterator("table",
			function(e) {
	...
	l.defaults = {
		...
		fnStateLoadCallback: function(a) {
			try {
				return JSON.parse((a.iStateDuration === -1 ? sessionStorage : localStorage).getItem(
		...
		oLanguage: {
			...
			sInfo: "显示 _TOTAL_ 条中的 _START_ 到 _END_ 条",
			// sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",
			sInfoEmpty: "显示 0 到 0 条数据，共0条数据",
	...
	l.models.oSettings = {
		...
		fnDisplayEnd: function() {
			var a = this._iDisplayLength,
				...
				e = this.oFeatures,
				f = e.bPaginate;
			return e.bServerSide ? f === false || a === -1 ? b + d : Math.min(b + a, this
				._iRecordsDisplay) : !f || c > d || a === -1 ? d : c
		},
		oInstance: null,
		sInstance: null,
		iTabIndex: 0,
				...
				h(a.nTable).on("order.dt.DT", function(e, f, g, h) {
					if (a === f) {
						...
						b.find("span." + d.sSortIcon).removeClass(d.sSortJUIAsc + " " + d
							...
							" " + d.sSortJUIDescAllowed).addClass(h[e] == "asc" ? d
							.sSortJUIAsc : h[e] == "desc" ? d.sSortJUIDesc : c
							.sSortingClassJUI)
					}
				})
			}
